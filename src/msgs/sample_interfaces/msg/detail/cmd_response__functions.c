...
sample_interfaces__msg__CmdResponse__init(sample_interfaces__msg__CmdResponse * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->text)) {
    sample_interfaces__msg__CmdResponse__fini(msg);
    return false;
  }
  return true;
}
...
sample_interfaces__msg__CmdResponse__create()
{
  ...
  sample_interfaces__msg__CmdResponse * msg = (sample_interfaces__msg__CmdResponse *)allocator.allocate(sizeof(sample_interfaces__msg__CmdResponse), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(sample_interfaces__msg__CmdResponse));
  bool success = sample_interfaces__msg__CmdResponse__init(msg);
  if (!success) {
...
sample_interfaces__msg__CmdResponse__Sequence__init(sample_interfaces__msg__CmdResponse__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sample_interfaces__msg__CmdResponse * data = NULL;

  if (size) {
    data = (sample_interfaces__msg__CmdResponse *)allocator.zero_allocate(size, sizeof(sample_interfaces__msg__CmdResponse), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = sample_interfaces__msg__CmdResponse__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        sample_interfaces__msg__CmdResponse__fini(&data[i - 1]);
      }
...
sample_interfaces__msg__CmdResponse__Sequence__fini(sample_interfaces__msg__CmdResponse__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      sample_interfaces__msg__CmdResponse__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sample_interfaces__msg__CmdResponse__Sequence * array = (sample_interfaces__msg__CmdResponse__Sequence *)allocator.allocate(sizeof(sample_interfaces__msg__CmdResponse__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = sample_interfaces__msg__CmdResponse__Sequence__init(array, size);
  if (!success) {
...
sample_interfaces__msg__CmdResponse__Sequence__destroy(sample_interfaces__msg__CmdResponse__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    sample_interfaces__msg__CmdResponse__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
sample_interfaces__msg__CmdResponse__Sequence__are_equal(const sample_interfaces__msg__CmdResponse__Sequence * lhs, const sample_interfaces__msg__CmdResponse__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!sample_interfaces__msg__CmdResponse__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  sample_interfaces__msg__CmdResponse__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(sample_interfaces__msg__CmdResponse);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    sample_interfaces__msg__CmdResponse * data =
      (sample_interfaces__msg__CmdResponse *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!sample_interfaces__msg__CmdResponse__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          sample_interfaces__msg__CmdResponse__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!sample_interfaces__msg__CmdResponse__copy(
